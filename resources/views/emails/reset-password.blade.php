...
<body style="font-family: Cambria, Cochin, Georgia, Times, 'Times New Roman', serif; color: #2c2c2c;">
    ...
    <a href="https://www.new-horizons-game.com/request/reset-password?code={{ $passwordResetCode }}">https://www.new-horizons-game.com/request/reset-password?code={{ $passwordResetCode }}</a>
